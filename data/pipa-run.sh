...
# Generated at 2025-07-09T10:06:11.417256
...
perf record -e '{cycles,instructions}:S' -g -a -F 200 -o $WORKSPACE/perf.data /usr/bin/taskset -c 0-15 None
...
sar_pid=$!
perf stat -e cycles,instructions,branch-misses,L1-dcache-load-misses,L1-icache-load-misses -C 0-15 -A -x , -I 1000 -o $WORKSPACE/perf-stat.csv /usr/bin/taskset -c 0-15 None
kill -9 $sar_pid
